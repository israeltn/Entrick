            ...
            {/* <section className="py-24">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-gray-500 text-base max-w-2xl mx-auto mb-20 font-medium">
                        Our diverse team consists of Cybersecurity, AI specialists, product designers, and AI/ML experts, all dedicated to ensuring Entrick remains at the forefront of AI automation.
                    </p>
